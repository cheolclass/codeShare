...
public class ObstacleSpawner4 : MonoBehaviour
{
	[SerializeField]
	...
	[SerializeField]
	private float currentSpawnTime = 0.01f;        // 장애물 생성 주기
	[SerializeField]
	...
	private void SpawnObject()
	{
		...
		if (clone.TryGetComponent<Obstacle4>(out var obstacle))  /// check: 객체 null & 컴포넌트 존재 여부
		{
